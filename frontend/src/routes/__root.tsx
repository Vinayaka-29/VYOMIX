...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Multimodal Vision-Language Satellite Intelligence by VYOMIX." },
      { name: "author", content: "VYOMIX" },
      { property: "og:title", content: "Earth Query Lens — VYOMIX" },
      { property: "og:description", content: "Multimodal Vision-Language Satellite Intelligence by VYOMIX." },
